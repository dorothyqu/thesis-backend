...
from flask.todo.collage_functions import colorpalette
from flask.todo.collage_functions.Collage import Collage
from flask.todo.collage_functions.colorpalette import *
import random
